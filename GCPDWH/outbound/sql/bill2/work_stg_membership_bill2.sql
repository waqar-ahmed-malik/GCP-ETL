...
CASE WHEN MEM.ASSOCIATE_ID=1 THEN IFNULL(CREDIT.TOTAL_BILL_AMT, 0) ELSE 0 END AS TOTAL_AMT_DUE, 
	...
	CASE WHEN MEM.ASSOCIATE_ID=1 THEN IFNULL(CREDIT.TOTAL_PAYMENTS, 0) ELSE 0 END AS PAYMENT_RECEIVED,  
...
CREDIT_CARD_LAST_4_DIGITS,NO_OF_ASSOCIATES_CNT,CURRENTLY_HAS_AUTO,SECONDARY_MEMBER_IND,TOTAL_PAYMENTS,
