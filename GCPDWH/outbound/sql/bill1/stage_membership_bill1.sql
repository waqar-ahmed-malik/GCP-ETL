...
MAX(CASE WHEN BILL_PAY_METHOD<>'1' and MEMBER_SEQUENCE_NUM=1 THEN IFNULL(TOTAL_AMT_DUE,0) ELSE 0 END) AS TOTAL_AMT_DUE,
MAX(CASE WHEN BILL_PAY_METHOD<>'1' and MEMBER_SEQUENCE_NUM=1 THEN 0 ELSE IFNULL(TOTAL_AMT_DUE,0) END) AS TOTAL_AMT_PAID,
...
from LANDING.WORK_STG_MEMBERSHIP_BILL1
