MERGE `OPERATIONAL.AMS_LOCATION_COVERAGE` AS TGT
USING `LANDING.WORK_AMS_LOCATION_COVERAGE` AS SRC
ON TGT.UNIQUE_LOCATION_COVERAGE = SAFE_CAST(SRC.UNIQLOCATIONCOVERAGE AS INT64)

WHEN MATCHED
THEN UPDATE SET
TGT.UNIQUE_LOCATION_COVERAGE = SAFE_CAST(SRC.UNIQLOCATIONCOVERAGE AS INT64)
,TGT.UNIQUE_LINE_IMAGE = SAFE_CAST(SRC.UNIQLINEIMAGE AS INT64)
,TGT.UNIQUE_COVERAGE = SAFE_CAST(SRC.UNIQCOVERAGE AS INT64)
,TGT.UNIQUE_AP_LOCATION = SAFE_CAST(SRC.UNIQAPLOCATION AS INT64)
,TGT.UNIQUE_AP_BUILDING = SAFE_CAST(SRC.UNIQAPBUILDING AS INT64)
,TGT.UNIQUE_PERSONAL_AP_LOCATION = SAFE_CAST(SRC.UNIQPERSONALAPLOCATION AS INT64)
...
,TGT.OTHER_SYMBOL_1 = SAFE_CAST(SRC.OTHERSYMBOL1 AS STRING)
,TGT.UNIQUE_AA_LOCATION = SAFE_CAST(SRC.UNIQAALOCATION AS INT64)
,TGT.UNIQUE_AA_BUILDING = SAFE_CAST(SRC.UNIQAABUILDING AS INT64)
,TGT.NUM_VALUE_STR_1 = SAFE_CAST(SRC.NUMVALUESTR1 AS STRING)

WHEN NOT MATCHED
THEN INSERT ( --Target column names
UNIQUE_LOCATION_COVERAGE
,UNIQUE_LINE_IMAGE
,UNIQUE_COVERAGE
,UNIQUE_AP_LOCATION
,UNIQUE_AP_BUILDING
,UNIQUE_PERSONAL_AP_LOCATION
,RATE_1
,RATE_2
,FULL_TERM_PREMIUM
,NET_CHANGE_PREMIUM
...
SAFE_CAST(UNIQLOCATIONCOVERAGE AS INT64)
,SAFE_CAST(UNIQLINEIMAGE AS INT64)
,SAFE_CAST(UNIQCOVERAGE AS INT64)
,SAFE_CAST(UNIQAPLOCATION AS INT64)
,SAFE_CAST(UNIQAPBUILDING AS INT64)
,SAFE_CAST(UNIQPERSONALAPLOCATION AS INT64)
...
,SAFE_CAST(OTHERSYMBOL1 AS STRING)
,SAFE_CAST(UNIQAALOCATION AS INT64)
,SAFE_CAST(UNIQAABUILDING AS INT64)
,SAFE_CAST(NUMVALUESTR1 AS STRING)
)
