...
USING LANDING.WORK_TRAVEL_TST_TRANSACTIONS AS SRC
ON TGT.SOURCE_TRANSACTION_ID = SRC.SOURCE_TRANSACTION_ID 
AND TGT.SOURCE_SYSTEM_CD = SRC.SOURCE_SYSTEM_CD
WHEN MATCHED
THEN UPDATE SET
TGT.TRIP_TRANSACTION_NUM = SAFE_CAST(SRC.TRIP_TRANSACTION_NUM AS STRING),
TGT.TRANSACTION_DT =SRC.TRANSACTION_DT,
...
TGT.SALE_POSTED_AMT = SRC.SALE_POSTED_AMOUNT,
...
TGT.DEPARTURE_DT = SRC.DEPARTURE_DT,
...
TGT.ANTICIPATED_SALE_AMT = SAFE_CAST(SRC.ANTICIPATED_SALE_AMOUNT AS STRING),
TGT.ANTICIPATED_COMMISSION_AMT = SAFE_CAST(SRC.ANTICIPATED_COMMISSION_AMOUNT AS STRING),
TGT.DESTINATION_CITY = SRC.DESTINATION_CITY,
TGT.DESTINATION_REGION = SRC.DESTINATION_REGION,
TGT.PASSENGER_COUNT = SAFE_CAST(SRC.PASSENGER_COUNT AS STRING),
...
SAFE_CAST(SRC.TRIP_TRANSACTION_NUM AS STRING),
SRC.TRANSACTION_DT,
...
SAFE_CAST(SRC.ANTICIPATED_SALE_AMOUNT AS STRING),
SAFE_CAST(SRC.ANTICIPATED_COMMISSION_AMOUNT AS STRING),
SRC.DESTINATION_CITY,
SRC.DESTINATION_REGION,
SAFE_CAST(SRC.PASSENGER_COUNT AS STRING),
SRC.AIRLINE,
SRC.TICKET_NUM,
SRC.ITINERARY,
SRC.PROVIDER,
