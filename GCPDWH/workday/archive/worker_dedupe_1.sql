SELECT
  ...
  CONCAT(
    ...
    COALESCE(CAST(aa.Worker_Travel_ID AS STRING),''),
    ...
    COALESCE(CAST(aa.HIRE_DT AS STRING),''),
    COALESCE(CAST(aa.TERMINATION_DT AS STRING),''),
    COALESCE(CAST(aa.ORGANIZATION_ID AS STRING),''),
    COALESCE(CAST(aa.EMPLOYEE_STATUS AS STRING),''),
