...
This module reads data from MSSQL and Write into Bigquery Table
'''
import datetime
import os
import argparse
...
def run():
    ...
    print(query)
    #.replace('v_incr_date',incrementaldate)
    ...
    for chunk in pandas.read_sql(query, cnx, coerce_float=True, params=None, parse_dates=None, columns=None,chunksize=10000):
