...
--    LANDING.WORK_ERS_STG_SERVICE_PROVIDED AS SRC
--  WHERE
--    SP.COMM_CTR_ID = SRC.COMM_CTR_ID
--    AND SP.SC_DT = SAFE_CAST(SRC.SC_DT AS DATETIME)
--    AND SP.SC_ID = SAFE_CAST(SRC.SC_ID AS INT64)
--    AND SP.SVCP_ID != SAFE_CAST(SRC.SVCP_ID AS INT64) )
