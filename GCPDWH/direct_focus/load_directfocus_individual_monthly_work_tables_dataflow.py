...
def run():
    ...
    try:
        ...
        (dummy_env | 'WORK INDIVIDUAL' >>  beam.ParDo(readfromssql(),direct_focus_work_individual ,landingtablename)
...
def main(args_config,args_productconfig,args_env,args_connectionprefix,args_incrementaldate,args_partition,args_landingtablename):
    ...
    global jobname
    jobname="load-individual-"+product_config['productname']+'-'+partition+'-'+time.strftime("%Y%m%d")
    ...
    direct_focus_work_individual = readfileasstring(cwd + '/sql/Monthly/work_individual.sql').replace('v_modvalue',partition).replace('v_incr_date',incrementaldate)
    if partition=='0':
        direct_focus_work_individual_md5 = readfileasstring(cwd + '/sql/Monthly/insert_work_individual_md5_0.sql')
    elif partition=='1':
        direct_focus_work_individual_md5 = readfileasstring(cwd + '/sql/Monthly/insert_work_individual_md5_1.sql')    
    elif partition=='2':
        direct_focus_work_individual_md5 = readfileasstring(cwd + '/sql/Monthly/insert_work_individual_md5_2.sql')    
    elif partition=='3':
        direct_focus_work_individual_md5 = readfileasstring(cwd + '/sql/Monthly/insert_work_individual_md5_3.sql')    
    elif partition=='4':
        direct_focus_work_individual_md5 = readfileasstring(cwd + '/sql/Monthly/insert_work_individual_md5_4.sql')    
